export class Carousel {
    constructor(anterior, proximo, listaProdutos, navegacao) {
        ...
        this.proximo.addEventListener('click', this.proximoSlide.bind(this)) //usa o bind(this) para mostrar que é o this do carousel
    ...
    pularParaSlide(evento) {
        if (evento.target === evento.currentTarget) return //esse return mata a função, não faz nada
